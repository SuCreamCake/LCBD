...
public class BossAtk : MonoBehaviour
{
    ...
    private BossManager MonsterManager;
    ...
    void Start()
    {
        ...
        MonsterManager = GetComponent<BossManager>();
    ...
    public void Attack()
    {
        ...
        if (!AtkCall)
        {
            ...
            if (isFlipped)
            {
                ...
                SpawnAttackCollider(transform.position + new Vector3(0f, 0f, 0f));
            }
            else
            {
                // 왼쪽으로 공격
